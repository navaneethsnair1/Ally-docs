export const samples=[
    ...
    {
        section:'Use',
        url1:'https://openliberty.io/docs/latest/reference/javadoc/spi/appClientSupport-1.0.com.ibm.wsspi.anno.classsource.html?path=24.0.0.5/com.ibm.websphere.appserver.spi.anno_1.1-javadoc/com/ibm/wsspi/anno/classsource/class-use/ClassSource_ScanCounts.ResultField.html',
        url2:'https://openliberty.io/docs/latest/reference/javadoc/spi/beanValidation-2.0.com.ibm.ws.adaptable.module.structure.html?path=24.0.0.8/com.ibm.websphere.appserver.spi.artifact_1.2-javadoc/com/ibm/ws/adaptable/module/structure/package-use.html'
    }
]